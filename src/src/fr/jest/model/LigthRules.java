 ...
 * <ul>
 * <li>les DIAMONDS à points négatifs  :  non-autorisés <br></li>
 * <li>la règle entre le les HEARTS et le JOKER  :  non-autorisée<br> </li>
 ...
 *@see Jest
 */
public class LigthRules extends JestEvalMethod {
/**
 ...
 */
	public LigthRules() {
		...
		this.negativeDiamonds = 0 ; //NOPE
		this.heartsAndJokerRule = 0 ; //NOPE
		this.blackPairRule = 1 ; //YESS
		this.jokerValue = 4 ;  //YESS
		this.aceRule=1; //YESS
	}
	/**
	 * Determine la valeur du Jest du Joueur cible<br>
	 * @see JestEvalMethod
	 * @return la valeur du Jest en appliquant les {@link LigthRules}
	 */
